...
| **Sprint 1 Goal** | Our focus is on providing an attractive and informative introduction site to new visitors. We believe it delivers a better idea of who we are and what we can do to help in their bakery needs. This will be confirmed when new visitors start to communicate with us for more information about our product and services. |
...
| **Attendees** | • Molina Vásquez, Manuel Alejandro (u20221g231)<br>• Tufiño Argüelles, Luis Angel (U202216240)<br>• Céspedes Pillco, Jarod Jack (u202318588)<br>• Vidal Malaga, Jareth Beycker (u202316878)<br>• Chipana Huarancca, Emanuel (u202214074) |
| **Sprint Goal & User Stories** | **Sprint Goal & User Stories** |
| **Sprint 2 Goal** | Our focus is on improving the information that we provide to new visitors, and creating an easy and practical way for our users to manage their bakery. We believe it delivers an easier plan selection to visitors, and a more simple way of monitoring their products, inventory and production. This will be confirmed when visitors know better what plan to subscribe to, and users can supervise their stock and products through our application without any issues. |
...
<table border="1" cellpadding="8" cellspacing="0" style="border-collapse: collapse; width: 100%;">
  <tbody>
    ...
    <tr><td><strong>Sprint 3 Goal</strong></td><td>Our focus is on providing more information to new visitors, improving the bakery supervision process for users, and giving a way to developers to add new features in the application. We believe it delivers a sense of determination to visitors to choose the correct plan that best suits their needs, a more detailed information of the monitoring results to users, and opportunities for implementing new monitoring-related features to the development team. This will be confirmed when visitors know exactly which plan is the best for them, users get a better view of how their bakery is doing, and developers add new features related to the monitoring system by themselves using the provided endpoints.</td></tr>
